...
export const SPX_GET_GUYS_REG_EML_CAPTCHA = "SPX_GET_GUYS_REG_EML_CAPTCHA";// 获取用户注册邮件验证码
export const SPX_VALID_GUYS_REG_SMS_CAPTCHA = "SPX_VALID_GUYS_REG_SMS_CAPTCHA";// 校验短信验证码
export const SPX_VALID_GUYS_REG_EML_CAPTCHA = "SPX_VALID_GUYS_REG_EML_CAPTCHA";// 校验邮箱验证码
